 ...
 *
 * for {@link repeater.aplombee.navigator.AjaxItemsNavigator} {@link ReUse.DEFAULT_ROWSNAVIGATOR} is preferred
 *
<<<<<<< HEAD:wicket-quickview/src/main/java/com/repeater/QuickView.java
...
=======
 * add quickview to a Markupcontainer to use with {@link repeater.aplombee.navigator.AjaxItemsNavigator}  or if you want to add new rows
