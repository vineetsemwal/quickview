...
public enum ReUse {
 ...
 DEFAULT_PAGING,
    ...
    /**
     * all children are removed and children of first page are created again ,mostly used and preferred for {@link repeater.aplombee.navigator.AjaxItemsNavigator}
     */
  ...
  CURRENTPAGE,
    ...
    /**
     *     all children are reused,no child gets removed  or recreated,this should only be used with {@link repeater.aplombee.navigator.AjaxItemsNavigator},
