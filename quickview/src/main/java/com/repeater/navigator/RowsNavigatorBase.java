...
/**
 * base navigator which is inherited by {@link  AjaxRowsNavigator}
 *
 * @author Vineet Semwal
 */
public abstract class RowsNavigatorBase extends Panel {
    ...
    private static Logger logger = Logger.getLogger(RowsNavigatorBase.class);
    ...
    public RowsNavigatorBase(String id, IModel model, IQuickView repeater) {
        super(id, model);
